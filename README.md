...
~~~sh
# getting the code
git clone git@github.com:nko4/team-name.git && cd ./team-name/

# developing
npm install
npm start

# deploying (to http://team-name.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@team-name.2013.nodeknockout.com
ssh root@team-name.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@team-name.2013.nodeknockout.com
ssh -i ./id_deploy root@team-name.2013.nodeknockout.com
~~~
